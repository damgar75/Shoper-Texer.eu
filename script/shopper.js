...
window.addEventListener('load', function(){
  ...
  div.innerHTML = '<li><span><i class="fa fa-phone"></i><a class="link-tel" href="tel:334820680">  33 482-06-80</a></span></li><li><i class="fa fa-clock-o"></i><span>  8.00-15.00 pn-pt</span></li><li><i class="fa fa-envelope"></i> <a href="mailto:biuro@carmat.pl" class="link-mail">  biuro@carmat.pl</a></li>';
  div.className = "links left inline";
...
//
// 	Load();
// 	$(".field_marka ul").addClass("hidden");
// 	$(".field_model ul").addClass("hidden");
//
// 	$(".field_marka li").click(function(){
// 		if(!$(".field_model ul").hasClass("hidden")){
...
// 			}
// 		}
// 		if($(".field_marka ul").hasClass("hidden")){
